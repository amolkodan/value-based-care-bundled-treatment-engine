...
def generate_synthetic_claims_dataset(
    ...
    dx_pool = ["E11.9", "I10", "J45.909", "F32.9", "M54.5", "N18.3", "I25.10", "E78.5"]
    ...
    procedure_pool = ["99213", "99214", "93000", "71046", "36415", "45378", "80053", "G0402"]
    ...
    claim_line_df = pd.DataFrame(
        {
            ...
            "modifier": rng.choice([None, "25", "59"], size=total_lines, p=[0.7, 0.2, 0.1]),
            "units": units,
